...
- [WiFiManager](#wifimanager)
  ...
  - [Quick Start](#quick-start)
    - [Installing](#installing)
      - [Install through Library Manager](#install-through-library-manager)
      - [Checkout from github](#checkout-from-github)
    - [Using](#using)
      - [Install Using PlatformIO](#install-using-platformio)
  - [Documentation](#documentation)
      ...
      - [On Demand Configuration Portal](#on-demand-configuration-portal)
      - [Exiting from the Configuration Portal](#exiting-from-the-configuration-portal)
  ...
  - [Releases](#releases)
    ...
    - [Development Overview](#development-overview)
      - [Added Public Methods](#added-public-methods)
